...
- **Escalier** : trois doubles volées jusqu'au dernier niveau, douze marches par volée (environ 16 cm de hauteur), paillasses pleines inclinées, mains courantes continues et garde-corps de palier, fenêtres et vide central de 60 unités. Le dernier palier n'a plus de volée qui monte dans le toit. Le vide central constitue un axe vertical d'embuscade.
...
`http://127.0.0.1:5214/tools/building-preview.html` fournit quatre points de vue fixes ainsi qu'une mesure du fusil et un bouton de recul. Le fusil est cadré à l'épaule, sa crosse et sa poignée sortant du cadre ; des mains gantées et des manches procédurales assurent la prise en main.
...
La touche **N** active/désactive la vision nocturne verte en partie. Le même réglage est disponible dans **SETTINGS → Vision nocturne · N** et dans l'aperçu. Il fonctionne indépendamment de la lampe **F** : illuminateur IR avec ombres, signal monochrome vert, grain discret et vignette. Ce n'est pas une vision thermique. Le mode est désactivé au démarrage.

## Départ du joueur

Le joueur apparaît toujours à l'entrée du **RDC**, y compris au redémarrage et lors d'une réapparition de développement. Le point d'entrée humain est distinct du pool de points utilisé par les bots. Les étages sont repérés RDC, 01, 02 et 03.
